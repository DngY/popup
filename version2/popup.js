...
Popup.prototype = {
	...
	build: function() {
		...
		var close='<a id="dialogBoxClose" title="close" style="padding:0;font-weight:bold;color:#888;background:#C6E3FF;cursor:pointer;font-size:14px;font-family:Airal;">脳</a>';
		//var close = '<input type="image" id="dialogBoxClose" src="' + path + '" border="0" width="16" height="16" align="absmiddle" title="close"/>';
...
function isCookieThere() {
	var cookie_rm = getCookie("CIO_SSO_LOGIN");
	var cookie_tm = getCookie("CIO_SSO_LOGIN_TM");
	//console.log("cookie_rm : " + cookie_rm);
	//console.log("cookie_tm : " + cookie_tm);
	if("" == cookie_rm && "" == cookie_tm) {
		return false;
	}else {
		return true;
	}
